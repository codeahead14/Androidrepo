...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_temp_set),
                mContext.getString(R.string.pref_temp_metrics));

        if (unitType.equals(mContext.getString(R.string.pref_temp_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_temp_metrics))) {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            // add to database - Cannot insert vector directly so we convert it to an array
            if ( cVVector.size() > 0 ) {
